...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("haxel bird", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("haxel bird", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "haxel bird";
		app.meta["name"] = "haxel bird";
